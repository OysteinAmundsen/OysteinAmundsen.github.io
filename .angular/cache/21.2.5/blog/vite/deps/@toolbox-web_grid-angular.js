import {
  FormGroup
} from "./chunk-GIYLNX42.js";
import "./chunk-MRUJ3MGN.js";
import "./chunk-U2MM675R.js";
import {
  ApplicationRef,
  ContentChild,
  DestroyRef,
...
var GridFormArray = class _GridFormArray {
  ...
  syncFormArrayToGrid = effect(() => {
    ...
    this.valueChangesSubscription = formArray.valueChanges.pipe(startWith(formArray.getRawValue()), takeUntilDestroyed(this.destroyRef)).subscribe(() => {
...
var Grid = class _Grid {
  ...
  async configureMasterDetail(grid) {
    ...
    const {
      MasterDetailPlugin
    } = await import("./master-detail-ETWABONQ.js");
